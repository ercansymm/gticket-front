      ...
      <main className="tc-page">
        ...
        <div className="tc-banner">
          ...
          <h1 className="tc-banner__title">
            {isFinalized ? 'Biletiniz Oluşturuldu!' : 'Ödeme Başarılı!'}
          </h1>
          <p className="tc-banner__subtitle">
            PNR kodunuz aşağıda belirtilmiştir.
          </p>
          {contactInfo?.email && (
            <div className="tc-banner__email-note">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/>
              </svg>
              Biletiniz <strong style={{ marginLeft: 3 }}>{contactInfo.email}</strong> adresine gönderildi
            </div>
          )}
        </div>
        ...
        <div className="tc-content">
          ...
          <div className="tc-summary-card">
            <div className="tc-summary-card__col">
              ...
              <button
                className={`tc-pnr-copy ${pnrCopied ? 'tc-pnr-copy--copied' : ''}`}
                onClick={() => {
          ...
          <div className="tc-bottom">
            ...
            <div className="tc-actions">
              <button className="tc-btn tc-btn--green" onClick={handleGoHome}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
