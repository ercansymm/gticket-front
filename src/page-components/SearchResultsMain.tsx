...
import { searchFlightsThunk, setSelectedFlight } from '../redux/features/flightSlice';
...
const SearchResultsMain = () => {
  ...
  const { searchResults, searchLoading, searchError, searchParams } = useSelector(
    (state: RootState) => state.flight
  );

  const handleSelectFlight = (flight: FlightResult) => {
    dispatch(setSelectedFlight(flight));
    // İleride allocate sayfasına yönlendirilecek
  };
