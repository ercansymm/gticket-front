          ...
          <>
            <div className="bb-search-toolbar">
              ...
              <button
                ...
                className={`bb-search-toolbar__edit-btn${activePanel === 'edit' ? ' is-active' : ''}`}
              ...
              >
                ...
                <svg className={`bb-search-toolbar__chevron${activePanel === 'edit' ? ' is-open' : ''}`} width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
